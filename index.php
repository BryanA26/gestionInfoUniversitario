...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
        <div class="container">
            ...
            <a class="navbar-brand logo-text" href="index.html">SGU</a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#plans">Soporte</a>
                    </li>
                    <?php if ($rol == "Administrador"): ?>
                                <li><a class="dropdown-item" href="/sgiu/views/usuarios.php">Usuarios</a></li>
                            <?php endif; ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="dropdown01" data-bs-toggle="dropdown" aria-expanded="false" href="#">Mapa</a>

                        <ul class="dropdown-menu" aria-labelledby="dropdown01">
                            <li><a class="dropdown-item" href="/sgiu/views/viewProducto.php">Producto</a></li>
                            <li>
                                <div class="dropdown-divider"></div>
                            </li>
                            <li><a class="dropdown-item" href="/sgiu/views/viewProyecto.php">Proyecto</a></li>
                            <li>
                                <div class="dropdown-divider"></div>
                            </li>
                            <li><a class="dropdown-item" href="/sgiu/views/viewTipoProducto.php">Tipo Producto</a></li>
                    ...
                    <li class="nav-item">
                        <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
                            <a class="nav-link" href="#"><i class="fas fa-user"></i> Hola, <?php echo $_SESSION['usuario']; ?></a>
                        <?php else: ?>
